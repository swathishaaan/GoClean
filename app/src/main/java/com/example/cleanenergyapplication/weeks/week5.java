...
import com.example.cleanenergyapplication.MainActivity;
import com.example.cleanenergyapplication.R;
import com.example.cleanenergyapplication.UserInput;
...
public class week5 extends AppCompatActivity {
    ...
    private void launchHome() {
        Intent intent= new Intent(week5.this, UserInput.class);
        startActivity(intent);
    }
